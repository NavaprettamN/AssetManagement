                      ...
                      <div class="row m-l-0 m-r-0">
                          ...
                          <div class="col-sm-8">
                              <div class="card-block">
                                  ...
                                  <div class="row">
                                      <div class="col-sm-6">
                                          <p class="m-b-10 f-w-600">Admin type</p>
                                          <h6 class="text-muted f-w-400" id="adminType"></h6>
                                      </div>
                                      <div class="col-sm-6">
					...
					success: function(users) {
						...
						users.forEach(function(user) {
							if(user.empId == empId) {
								...
								$("#role").text((user.isAdmin === "superAdmin")? "Super Admin": "Admin");
								$("#empMail").text(user.empMail);
								$("#department").text(user.department);
								$("#location").text(user.location);
					
								$("#adminType").text((user.isAdmin === "superAdmin")? "Super Admin": "Admin");
								var contextPath = "<%=request.getContextPath() %>";
